...
export interface WechatOrdersPayOrderNoGetParams {
  /** 支付类型 1:微信支付; 2:支付宝支付; 3:线下支付; 4:余额支付 */
  payType?: number;

  /** 交易方式 NATIVE; APP; JSAPI; MWEB */
  tradeType?: string;
...
export interface WechatMallSigninPutParams {
  /** type */
  type?: number;
}
...
export interface WechatAuthTokenGetParams {
  /** 微信code */
  code?: string;
...
export interface WechatApiQrCodeGenerateUrlLinkPostParams {
  /**
   * path
   * @example
   */
...
export interface WechatSocialUserFollowGroupGetParams {
  /**
   * 查询开始时间
   * @example
   */
...
export interface WechatSocialUserFollowUserGetParams {
  /**
   * 查询开始时间
   * @example
   */
...
export interface WechatSocialUserGetUserFollowGetParams {
  /**
   * userId
   * @example
   */
...
export interface WechatSocialUserHistoryGetParams {
  /**
   * 查询开始时间
   * @example
   */
...
export interface WechatSocialUserStatisticsGetParams {
  /**
   * userId
   * @example
   */
