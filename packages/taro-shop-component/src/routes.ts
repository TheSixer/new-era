...
export const routeNames = {
  ...
  mineVerifyDetail: '/pages/mine/verify/detail/index',
  mineVerifyCheckList: '/pages/mine/verify/checkList/index',
  mineVerifyVerifycode: '/pages/mine/verify/verifycode/index',
