...
import iconSortDefault from './icon_sort_default.png'
...
const Component: FC<ISortsProps> = (props) => {
  ...
  function renderArrow(isActive: boolean) {
    return <Image src={isActive ? iconSort : iconSortDefault} className={styles.iconSort} style={isActive ? iconStyle : {}} />
  }
        ...
        return (
          ...
          >
            ...
            <View className={styles.iconSort}>
              {!!item.sort && renderArrow(isActive)}
            </View>
          </View>
        )
      })}
